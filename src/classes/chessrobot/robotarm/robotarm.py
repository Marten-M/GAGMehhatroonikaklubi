...
class RobotArm(object):
    ...
    def get_servo_angles(self, distance_from_arm: float, height: float) -> Tuple[int, int]:
        ...
        a = 90 + -self.first_servo_zero_position_offset_angle + 180 - (arcsin(distance_from_arm / third_side) + get_angle_between_triangle_sides(area, self.first_arm_length, third_side))
        b = -self.second_servo_zero_position_offset_angle + 180 - get_angle_between_triangle_sides(area, self.first_arm_length, self.second_arm_length)
