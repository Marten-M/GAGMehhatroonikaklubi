...
FIRST_ARM_ZERO_POSITION_OFFSET_ANGLE_DEGREES = -15

SECOND_ARM_LENGTH_CM = 29
SECOND_ARM_ZERO_POSITION_OFFSET_ANGLE_DEGREES = 0

ARM_HEIGHT_CM = 15

ELECTROMAGNET_PULL_PIN = 24
ELECTROMAGNET_PUSH_PIN = 23
ELECTROMAGNET_HEIGHT_CM = 3

MAGNET_PULL_DISTANCE_CM = -1.3
PIECE_DROPOFF_HEIGHT_CM = -1
...
DEFAULT_ROBOT_ARM_POSITION = (98, 30, 17)
ROBOT_ARM_DISTANCE_TO_BOARD_CM = 16

HORIZONTAL_DIST_TO_REMOVED_BLACKS = 0
VERTICAL_DIST_TO_REMOVED_BLACKS = 5

HORIZONTAL_DIST_TO_REMOVED_WHITES = 22
VERTICAL_DIST_TO_REMOVED_WHITES = 10
