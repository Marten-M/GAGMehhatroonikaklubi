...
ELECTROMAGNET_PUSH_PIN = 7
ELECTROMAGNET_PULL_PIN = 8
...
CONTROLLER_UP_PIN = 26
CONTROLLER_DOWN_PIN = 19
CONTROLLER_LEFT_PIN = 13
CONTROLLER_RIGHT_PIN = 6
CONTROLLER_BACK_PIN = 5
CONTROLLER_ENTER_PIN = 23
