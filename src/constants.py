...
FIRST_ARM_ZERO_POSITION_OFFSET_ANGLE_DEGREES = 5

SECOND_ARM_LENGTH_CM = 29
SECOND_ARM_ZERO_POSITION_OFFSET_ANGLE_DEGREES = 5
...
MAGNET_PULL_DISTANCE_CM = 1
PIECE_DROPOFF_HEIGHT_CM = 0.4

STEPPER_ZERO_POSITION_DETECT_PIN = 12
STEPPER_ZERO_POSITION_ANGLE_TO_CHESS_BOARD_CENTER_DEGREES = 94
